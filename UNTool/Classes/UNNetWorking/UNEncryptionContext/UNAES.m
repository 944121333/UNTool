...

{
    ...
    NSData *result = [UNAES AES256ParmEncryptWithKey:key Encrypttext:data];
...

{
    ...
    NSData* result = [UNAES  AES256ParmDecryptWithKey:key Decrypttext:data];
